  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition flex items-center gap-2 shadow-sm">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 flex flex-col items-center justify-center text-gray-400">
        ...
        <p className="text-lg font-medium text-gray-600 mb-1">No Leads Found</p>
        <p className="text-sm">Your lead data table will appear here.</p>
      </div>
    </div>
  );
}