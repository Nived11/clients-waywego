...
import { Eye, Edit, UserPlus, Phone, Globe, Infinity, Users } from "lucide-react"; 
...
interface QueryTableProps {
  ...
  stageCounts?: any; 
  onEditClick: (query: any) => void; // 🔥 Edit ഐക്കൺ ക്ലിക്ക് ചെയ്യുമ്പോൾ ഡാറ്റ പാസ്സ് ചെയ്യാൻ
}

export default function QueryTable({ queries, loading, page, limit, totalCount, onPageChange, stageCounts, onEditClick }: QueryTableProps) {
                  ...
                  <tr key={idx} className="hover:bg-gray-50/80 transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center justify-center gap-1.5">
                        ...
                        {/* 🔥 Edit Button (Calling onEditClick) */}
                        <div 
                          ...
                          title="Edit Query"
                        >
                          <Edit size={13} className="text-slate-700" strokeWidth={2} />
                        </div>
