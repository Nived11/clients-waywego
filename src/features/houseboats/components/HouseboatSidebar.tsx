...
export default function HouseboatSidebar() {
  const topDestinations = [
    { name: "Alleppey", count: "38" },
    { name: "Kumarakom", count: "18" },
    { name: "Kollam", count: "4" },
    { name: "Cochin", count: "2" },
    { name: "Thrissur", count: "2" },
  ];
  ...
  return (
    <>
      ...
      <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
        <h3 className="text-xs font-bold text-gray-800 mb-4">Houseboats by Status</h3>
        <div className="flex items-center gap-5">
          {/* Donut Chart */}
          <div className="relative w-[100px] h-[100px] shrink-0 flex items-center justify-center">
            <div className="absolute inset-0 rounded-full" style={{ background: 'conic-gradient(#10b981 0% 87.5%, #ef4444 87.5% 90.8%, #f59e0b 90.8% 93.9%, #cbd5e1 93.9% 100%)' }}></div>
            <div className="absolute inset-3 bg-white rounded-full flex flex-col items-center justify-center">
              <span className="text-lg font-black text-gray-800 leading-none">64</span>
          ...
          <div className="flex-1 space-y-3">
            <div className="flex gap-2 items-center">
              ...
              <div className="flex justify-between w-full text-[11px] font-bold">
                ...
                <span className="text-gray-500">56 (87.5%)</span>
              </div>
            </div>
            <div className="flex gap-2 items-center">
              ...
              <div className="flex justify-between w-full text-[11px] font-bold">
                ...
                <span className="text-gray-500">4 (6.3%)</span>
              </div>
            </div>
            <div className="flex gap-2 items-center">
              ...
              <div className="flex justify-between w-full text-[11px] font-bold">
                ...
                <span className="text-gray-500">2 (3.1%)</span>
              </div>
            </div>
            <div className="flex gap-2 items-center">
      ...
      <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div className="space-y-1">
          {/* 🔥 LINK UPDATED HERE */}
          <Link href="/houseboats/add" className="w-full flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-colors group cursor-pointer">
            <div className="flex items-center gap-2.5 text-xs font-bold text-gray-700 group-hover:text-blue-600 transition-colors">
              <PlusCircle size={14} /> Add New Houseboat
            </div>
          ...
          <button className="w-full flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-colors group">
            <div className="flex items-center gap-2.5 text-xs font-bold text-gray-700 group-hover:text-blue-600 transition-colors">
              <LayoutGrid size={14} /> Add Houseboat Category
            </div>
            <ChevronRight size={14} className="text-gray-400 group-hover:text-blue-600" />
          </button>
          <button className="w-full flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-colors group">
          ...
          <button className="w-full flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-colors group">
            <div className="flex items-center gap-2.5 text-xs font-bold text-gray-700 group-hover:text-blue-600 transition-colors">
              <Download size={14} /> Bulk Update Prices
            </div>
            <ChevronRight size={14} className="text-gray-400 group-hover:text-blue-600" />
          </button>
        </div>
